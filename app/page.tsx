...
export default function Home() {
    ...
    return (
        <div className="d-flex align-items-center justify-content-center flex-grow-1 p-4 h-100">
            <div
                className="d-flex flex-column gap-4 font-semibold text-center pb-5"
              ...
              Forward Deployed Engineer - Project 2
                ...
                <Row>
                    {[
                        {
                            title: "GitHub",
                            link: "https://github.com/kaanokman/gorgias",
                            description: "The repository of the application published on GitHub",
                            variant: "dark",
                            icon: AiFillGithub,
                        },
                        {
